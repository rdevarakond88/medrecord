...
| **27e** | **Builder Agent — fix BUG-IT-1, BUG-IT-4** | BUG-IT-1: D5 must synchronously POST patient to server at save time. BUG-IT-4: Backend DELETE /patient/consents/:id must remove all consent records for the doctor-patient pair; D3 must reflect revoke. |
