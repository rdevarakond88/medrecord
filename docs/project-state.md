...
## New Screens — In Progress (post-pilot extension)
...
## Dashboard Sync
When this file is updated, also update the Current Status cell for `medrecord`
in `/home/rdeva/CLAUDE.md` Active Projects table. One line, keep it current.
